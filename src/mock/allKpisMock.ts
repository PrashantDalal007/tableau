...
export const allKpisMock: MetricCard[] = [
  {
    id: "aov",
  ...
  },
  {
    ...
    percentageColor: "green",
    previousValue: "2.44%",
    chartData: [2.1, 2.15, 2.6, 2.44, 2.5, 2.7, 2.84],
    ...
    rangeHigh: "3.0%",
    trendInsight:
      "Conversion rate has increased due to improved mobile experience.",
    description:
  ...
  },
  {
    ...
    percentageColor: "green",
    previousValue: "2.3%",
    chartData: [2.5, 2.3, 2.1, 2.0, 1.9, 1.8, 1.7],
    timeRange: "Month to Date",
    currency: false,
    summaryDate: "January 28, 2024",
    summaryValue: "1.7%",
    ...
    rangeHigh: "2.5%",
    trendInsight:
      "Refund rate has decreased, indicating improved product satisfaction.",
    description:
  ...
  },
  {
    ...
    percentageColor: "green",
    previousValue: "21.7k",
    chartData: [21000, 21500, 21800, 22000, 22200, 22350, 22500],
    timeRange: "Month to Date",
    currency: false,
    summaryDate: "January 28, 2024",
    summaryValue: "22.5k",
    ...
    rangeHigh: "23k",
    trendInsight:
      "Active user count has increased after gamification and rewards.",
    description:
